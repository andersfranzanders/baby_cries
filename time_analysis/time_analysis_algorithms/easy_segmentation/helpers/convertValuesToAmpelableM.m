function [ ampelMatrix ] = convertValuesToAmpelableM( values,segmentMatrix, support,minValue,maxValue,isOneGood)
...
for i = 1:rows
    ...
    ampelMatrix(i,3:5) = mapValueToAmpelColor(filledValues(1,i),minValue,maxValue,isOneGood);
