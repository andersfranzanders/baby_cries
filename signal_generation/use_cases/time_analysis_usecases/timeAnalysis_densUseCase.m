...
%%% First thing
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'xl', 'zero', 'l', 'zero', 'm');
x = [x,x_seg];
c = [c,c_seg];
...
%%% First second
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'xl', 'zero', 'm', 'zero', 'm');
x = [x,x_seg];
c = [c,c_seg];
...
%%% First second
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'xl', 'zero', 's', 'zero', 'm');
x = [x,x_seg];
c = [c,c_seg];
