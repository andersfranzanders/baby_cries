function [ x, c, Fs ] = timeAnalysis_useCase02( pathToCrySet, pathToNoiseSignal,aimSNRinDB )
...
%%% First thing
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'xl', 'zero', 'm', 'l', 'm');
x = [x,x_seg];
c = [c,c_seg];
...
%%% second thing
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'm', 'xl', 'm', 'zero', 'm');
x = [x,x_seg];
c = [c,c_seg];
...
%%% third thing
[ x_seg,c_seg ] = produceConstantSegment_words(crySet,Fs,'l', 'l', 'xl','m', 'l', 'm');
x = [x,x_seg];
c = [c,c_seg];
